...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 01 mars 2019 à 17:45
...
--
-- Base de données :  `forteroche_ebook`
--
...
INSERT INTO `chapters` (`chap_id`, `chap_order`, `chap_title`) VALUES
(1, 0, 'Titre du chapitre (ou catégorie) - extrait de Charles Darwin');
...
INSERT INTO `comments` (`com_id`, `com_author`, `com_text`, `com_flag`, `com_muted`, `com_modifier`, `com_part_id`) VALUES
(1, 'Invité', '\\&quot;Les espèces qui survivent ne sont pas les espèces les plus fortes, ni les plus intelligentes, mais celles qui s’adaptent le mieux aux changements.\\&quot;', 0, 0, '2019-02-28 11:03:50', 1),
(2, 'Jean Rochefort', '\\&quot;La sélection naturelle recherche, à chaque instant et dans le monde entier, les variations les plus légères; elle repousse celles qui sont nuisibles, elle conserve et accumule celles qui sont utiles.\\&quot;', 0, 0, '2019-02-28 11:04:21', 1);
...
ALTER TABLE `comments`
  ADD CONSTRAINT `F_KEY_part_id` FOREIGN KEY (`com_part_id`) REFERENCES `parts` (`part_id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Contraintes pour la table `parts`
--
ALTER TABLE `parts`
  ADD CONSTRAINT `F_KEY_chap_id` FOREIGN KEY (`part_chap_id`) REFERENCES `chapters` (`chap_id`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
