<!-- HTML - RGPD data -->
<div id="rgpd" class="theme-boxed theme-color theme-bckgrnd-color c-flx">
	<p>
		<span class="user-info">Ce site (est un projet de formation) utilise des cookies afin de promouvoir une meilleure expérience utilisateur...</span>
		<a href="#" onclick="javascript:explain_rgpd();"><strong class="user-info">Plus d'infos</strong></a>
		<button onclick="javascript:valid_rgpd();">OK</button>
	</p>
</div>
<div id="cookies" class="hidden-tag theme-double theme-dark-color theme-bckgrnd-color">
